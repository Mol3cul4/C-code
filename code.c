...
int main(void)
{
    ...
    printf("%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%C%c%c%c%c%c%c%c%c%c%c%c\n"
	   , 9^2,117,97,108,4*8,97,32,100,97,116,97,32,100,111,32,10^2,111,32,110,111,115,115,111,32,112,114
	   ,105,109,11*11-20,105,109,101,105,114,111,32,10*10-2,101,105,106,111,7*9);
